...
//
//        Intent intent = getIntent();
//        String nickName = intent.getStringExtra("nickName"); //MainActivity로부터 닉네임 전달 받음
//        String photoUrl = intent.getStringExtra("photoUrl"); //MainActivity로부터 프로필 사진 Uri 전달 받음
//
//        tv_result = findViewById(R.id.tv_result);
//        tv_result.setText(nickName); //닉네임 text를 텍스트 뷰에 세팅
//
